      ...
      <Container>
        <section id="intro" className="intro">
            <article className="intro__text">
              ...
              <p>I am a Full-Stack Developer specializing in Javascript, PHP and Python. I have used Wordpress, Laravel and, most recently, Django. This portfolio site is my first site built in Django.</p>

              <p>I have been lucky to have some great clients from diverse fields, including the NYTimes, EPIX TV, Weil Gotshal and Manges, Carnegie, and Lazard Asset Management among others. For a full (er) list, see below.</p>

              <p>
              Also interested in, in no particular order, in the JAM stack, Gatsby.js, Python Django framework, Data Visualization and Analysis, Machine Learning, and VR/AR.
              </p>

              <p>I came to web development from a background in media. I also write stuff.</p>
            </article>
        ...
        <section id="portfolio" className="portfolio">
          ...
          <ul className="portfolio__images">
            ...
            <li className="portfolio__images--image">
            <Image src={`client-logos/opera_rect.png`}/> 
            </li>
            <li className="portfolio__images--image">
            <Image src={`client-logos/lazard_asset_management_logo.jpg`}/> 
            </li>
            <li className="portfolio__images--image">
            <Image src={`client-logos/weil.jpg`}/> 
            </li>
            <li className="portfolio__images--image">
